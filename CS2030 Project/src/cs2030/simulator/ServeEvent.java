...
public class ServeEvent extends Event {
    public ServeEvent(int id, double time, int serverId, EventState eventState,
    ...
    public String toString() {
        ...
        return String.format("%.3f", super.getTime()) + " " + super.getId()
                + greedyState + " serves by server " + this.getServerId();
    }
}
